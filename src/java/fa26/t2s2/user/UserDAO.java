...
public class UserDAO {
    ...
    private static final String SEARCH = "SELECT userID, fullName, roleID FROM tblUsers WHERE fullName like ? AND status = 1";
    ...
    private static final String CHECKOUT = "SELECT pid, name, price, quantity FROM Product WHERE quantity > 0";
    ...
    public boolean delete(String userID) throws SQLException, Exception {
        boolean check = false;
        Connection conn = null;
        PreparedStatement ptm = null;
